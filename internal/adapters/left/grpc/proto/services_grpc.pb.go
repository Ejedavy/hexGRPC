...
type ArithmeticServiceClient interface {
	GetAddition(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Answer, error)
	GetMultiplication(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Answer, error)
	GetDivision(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Answer, error)
	GetSubtraction(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Answer, error)
}
...
func (c *arithmeticServiceClient) GetAddition(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
	err := c.cc.Invoke(ctx, "/proto.ArithmeticService/GetAddition", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *arithmeticServiceClient) GetMultiplication(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
	err := c.cc.Invoke(ctx, "/proto.ArithmeticService/GetMultiplication", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *arithmeticServiceClient) GetDivision(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
	err := c.cc.Invoke(ctx, "/proto.ArithmeticService/GetDivision", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *arithmeticServiceClient) GetSubtraction(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
	err := c.cc.Invoke(ctx, "/proto.ArithmeticService/GetSubtraction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArithmeticServiceServer interface {
	GetAddition(context.Context, *Operands) (*Answer, error)
	GetMultiplication(context.Context, *Operands) (*Answer, error)
	GetDivision(context.Context, *Operands) (*Answer, error)
	GetSubtraction(context.Context, *Operands) (*Answer, error)
...
func (UnimplementedArithmeticServiceServer) GetAddition(context.Context, *Operands) (*Answer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAddition not implemented")
}
func (UnimplementedArithmeticServiceServer) GetMultiplication(context.Context, *Operands) (*Answer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMultiplication not implemented")
}
func (UnimplementedArithmeticServiceServer) GetDivision(context.Context, *Operands) (*Answer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDivision not implemented")
}
func (UnimplementedArithmeticServiceServer) GetSubtraction(context.Context, *Operands) (*Answer, error) {
...
func _ArithmeticService_GetAddition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ArithmeticService/GetAddition",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetAddition(ctx, req.(*Operands))
	}
...
func _ArithmeticService_GetMultiplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ArithmeticService/GetMultiplication",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetMultiplication(ctx, req.(*Operands))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ArithmeticService_GetDivision_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ArithmeticService/GetDivision",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetDivision(ctx, req.(*Operands))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ArithmeticService_GetSubtraction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ArithmeticService/GetSubtraction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetSubtraction(ctx, req.(*Operands))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArithmeticService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/adapters/left/grpc/proto/services.proto",
}
