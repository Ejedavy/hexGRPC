...
type ArithmeticServiceClient interface {
	...
	GetSubstraction(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Answer, error)
}
...
func (c *arithmeticServiceClient) GetSubstraction(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
...
type ArithmeticServiceServer interface {
	...
	GetSubstraction(context.Context, *Operands) (*Answer, error)
...
func (UnimplementedArithmeticServiceServer) GetSubstraction(context.Context, *Operands) (*Answer, error) {
...
func _ArithmeticService_GetSubstraction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetSubstraction(ctx, req.(*Operands))
	}
	return interceptor(ctx, in, info, handler)
}
